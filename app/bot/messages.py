...
WEEKLY_REPORT_EMPTY_TEXT = "Отправь текст отчёта, потом нажми «✅ Отчёт готов»."
...
INSIGHT_DONE_BUTTON = "✅ Инсайт готов"
...
INSIGHT_EMPTY_TEXT = "Я не получил текст инсайта. Отправь инсайт текстом и нажми ✅ Инсайт готов."
